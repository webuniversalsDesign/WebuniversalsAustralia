...
<link rel="canonical" href="https://webuniversals.com/SearchEngineOptimization" />
   ...
   {/* <h4>Our Result-Oriented Approach</h4> */}
        ...
        <section className="gap no-bottom" style={{marginTop:"40px"}}>
      <div className="container">
      <div className="heading pb-5">
                  <h6>Different S E O</h6>

                  <h2>
             Service Provided By Us Are
                  </h2>
            ...
            <div className="grid row align-items-center">
              <div className="col-lg-3 col-md-6 col-sm-6 portfolio-img UI-Design Branding">
                <div className="portfolio-detail">
                  <div className="portfolio-img hoverstyle" style={{backgroundColor:"#f9f9f9"}}>
                    <figure>
                      <a href="">
                        <img
                          className="w-100"
                          alt="profile img"
                          src="assets/img/reviewAnalysist.jpg"
                        />
                      </a>
                    </figure>
                    <h3>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6 portfolio-img UI-Design Branding">
                <div className="portfolio-detail">
                  <div className="portfolio-img hoverstyle" style={{backgroundColor:"#f9f9f9"}}>
                    ...
                    <h3>
                      <p className="card-text">
                      Keyword investigate and Analysis
                      </p>
                    </h3>
                    ...
                    <figure>
                      <a href="">
                        <img
                          className="w-100"
                          alt="profile img"
                          src="assets/img/pressRelease.jpg"
                        />
                      </a>
                    </figure>
                    <h3>
                    ...
                    <figure>
                      <a href="">
                        <img
                          className="w-100"
                          alt="profile img"
                          src="assets/img/localResearch.jpg"
                        />
                      </a>
                    </figure>
                    <h3>
                    ...
                    <figure>
                      <a href="">
                        <img
                          className="w-100"
                          alt="profile img"
                          src="assets/img/blogCreation.jpg"
                        />
                      </a>
                    </figure>
                    <h3>
                    ...
                    <figure>
                      <a href="">
                        <img
                          className="w-100"
                          alt="profile img"
                          src="assets/img/onlineRelation.jpg"
                        />
                      </a>
                    </figure>
                    <h3>
